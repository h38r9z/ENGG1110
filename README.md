...
v1.4 2024/11/28 Due date postponed to 2024/12/06 (Fri) 23:59 
v1.3 2024/11/18 P.15 [] Fixed Typo of “Column” in vertical match 
message 
P.22 [6.3.2] Fixed “FindAndRemoveMatch” function 
name typo 
P.15,16 
[5.5.4] 
P.17 [5.6] 
...
Fixed Missing “=====” in some gameplay 
demo 
...
candies in ffrst round. 
P.14 [5.5.2] Added the checking of empty cells for 
Target cell at swap. 
P.14 [5.5.4] Added clariffcation on how 
ffndAndRemoveMatch() checking order. 
P.22 [6.3.2] Added clariffcation on how the cascade 
matching checking order. 
P.25 [8] Elaborated the grading speciffcation. 
...
2024-2025 Term 1 
Project 
Due Date: 2024/12/04 06 (Wed Fri) 23:59 
1. Introduction 
...
deducted from every modification. ENGG1110 Project 
2 of 26 
...
===== 
 ...
 4| # | * | | | | | 
 5| % | # | | * | % | @ | 
Game Over! No more possible moves. ENGG1110 Project 
9 of 26 
...
the target coordinate, and the di代 写ENGG1110、C++
代做程序编程语言rection as arguments. The function will then swap the 
...
Vertical Match found at column !\n 
...
** End of Part I ** ENGG1110 Project 
18 of 26 
...
spaces (represented by ASCII 32 ‘ ’). When such empty space is detected, shift any ENGG1110 Project 
20 of 26 
...
1. 
No more candies available. ENGG1110 Project 
22 of 26 
...
cell. For this, you will call findAndRemoveMatch() function (developed in part I) to find 
all matches on each non-empty cell. You can make use of the return value of 
findAndRemoveMatch() to determine whether a match is found. 
...
b. Check Directions: For each cell, check for matches in the o         
